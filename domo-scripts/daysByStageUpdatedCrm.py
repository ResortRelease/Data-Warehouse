...
# # # Create dataset
# # dsr.name = 'VPL | Status by Days'
# # dsr.description = 'Dispos for VPL'
...
generatedDispos = pd.DataFrame(newDispos, columns=["propertyid", "dispo", 'date'])
...
# updated_dataset = datasets.update("d15aae88-4950-420d-8a89-8624443dc533",
#                                   update)
